...
|fedora39|fedora:39|*5.38.2*|*8.2.22*|*8.0.35*|3.1.1|-|
|fedora40|fedora:40|*5.38.2*|*8.3.10*|*8.0.39*|3.2.2|-|
|cloud6 (\*1)|centos:7|*5.28.2*|*7.4.33*|*5.7.44*|1.0.2k|-|
|cloud7 (\*1)|rockylinux:9|*5.36.1*|8.2.22|MariaDB 10.5.22|3.0.7|-|
...
|sid|debian:sid|5.38.2|8.2.21|MariaDB 11.4.3|3.3.1|-|
...
|oracle8 (\*3)|oraclelinux:8|5.26.3|8.2.22|MariaDB 10.3.39|1.1.1k|-|
...
|chromiumdriver|movabletype/test:bookworm|chromedriver 127.0.6533.99|

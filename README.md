...
|fedora|fedora:32|*5.30.3*|7.4.15|*8.0.22*|1.1.1i|-|
|bullseye|bullseye|*5.32.1*|*7.4.15*|*MariaDB 10.5.8*|1.1.1i|-|
|cloud6 (\*1)|centos:7|*5.28.2*|*7.4.15*|*5.7.33*|1.0.2k|-|
|cloud7 (\*1)|centos:7|*5.28.2*|*7.4.15*|*5.7.33*|1.0.2k|-|
...
|amazonlinux|amazonlinux:2|5.16.3|7.3.26|MariaDB 5.5.68|1.0.2k|-|
